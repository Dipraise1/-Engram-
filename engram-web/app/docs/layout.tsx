      ...
      <header className="fixed top-0 left-0 right-0 z-40 h-14 border-b border-[#1e1525] bg-[#080608]/95 backdrop-blur-xl flex items-center">
        <div className="w-full flex items-center px-4 gap-4">
          ...
          <Link href="/" className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <span className="font-display font-light text-white text-[15px]">Engram</span>
          ...
          >
            ...
            <kbd className="text-[10px] font-mono border border-[#1e1525] px-1.5 py-0.5 rounded text-[#3a2845]">
              ⌘K
            </kbd>
          </button>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            {/* Mobile menu toggle */}
            <button
              className="lg:hidden text-[#6b5a7e] hover:text-white"
